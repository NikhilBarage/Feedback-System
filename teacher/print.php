...
<div class="container" id="print-section" style=" display: block; margin-right:30px; width: auto; height: auto; overflow: visible; position: absolute; top: 5%; left: auto; ">
  <div class="row">
    <div class="col-md-12">
      ...
      $sql = "SELECT * FROM $table WHERE t_name = '$login_session_name' ";
    ...
    ?></center>
      ...
      <tr> <th colspan="16" style="text-align: right; padding: 15px;"> Name of Faculty : <?php echo $login_session_name; ?>	</th> </tr>
      <tr>
      <th> Course Name </th>
      <th> Department </th>
