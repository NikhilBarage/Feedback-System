...
include('includes/navbar.php');
						...
						function tables($conn1, $nm, $term, $status1, $midorfinal) { ?>
							...
							<table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
								...
								<?php $table = $_SESSION['semname'] . 'sub';
								$sql = "SELECT * FROM $table WHERE t_name = '$nm' ";
								...
								?>
									<tr>
										...
										$result1 = mysqli_query($conn1, "SELECT * FROM `$table` WHERE sub_id = " . $row["id"] . " AND `term` = '$term' ");
	...
	<div class="container-fluid">
		...
		<div class="card shadow mb-4">
			<div class="card-header py-3">
				<h6 class="m-0 font-weight-bold text-primary"> Hello, <?= $login_session_name; ?>! <br>
					Your Performance Details <span class="kt-dashboard-title error-red"> </span>
					<div class="end" style="float: right;">
						<button type="button" class="btn btn-primary">
							<a href="print.php" style="color: white; text-decoration: none;"> | Print |</a>
						</button>
					</div>
				</h6>
			</div>
			...
			<div class="card-body">
				<div class="table-responsive">
					...
					<?php 		
						$func = "tables";
						$func($conn, $login_session_name, "m1", "midstatus", '1');
					?>
					...
					<?php
						$func = "tables";
						$func($conn, $login_session_name, "m2", "midstatus", '2');
					?>
					...
					<?php
						$func = "tables";
						$func($conn, $login_session_name, "f1", "finalstatus", '1');
					?>
